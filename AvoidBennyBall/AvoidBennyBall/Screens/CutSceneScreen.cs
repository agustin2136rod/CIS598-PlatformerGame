...
namespace AvoidBennyBall.Screens
{
    public class CutSceneScreen : GameScreen
    {
        ...
        public override void Activate()
        {
            ...
            _video = _content.Load<Video>("GameOnVideo ‑ Made with FlexClip");
        ...
        public override void Draw(GameTime gameTime)
        {
            if (_isPlaying)
            {
                ...
                */
                MessageBox.Show("Use the arrows on the keyboard to move the ghost around. The objective is to dodge Benny the Ball for as long as possible!", "", null);
            }
        }
    }
}
